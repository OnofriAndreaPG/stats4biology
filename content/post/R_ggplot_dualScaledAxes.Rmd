...
Ross Gilmoure from Galileo Consulting (Kuala Lumpur) sent me an interesting comment, proposing the use of the 'lubridate' package for the management of dates and of the 'ggh4x' package, to exploit the nested axis capabilities of this latter. Basically, his graph does not have facets, but the two years are put one after the other. Furthermore, he made use of minor ticks, which might be a good idea. Ross' code is following: I'd like to thank him very much!
...
ggplot(dataMeteo3, mapping = aes(x = interaction(Mth, Year),
  ...
  theme(
     ...
     ggh4x.axis.nestline.x = element_line(linewidth = 2),
