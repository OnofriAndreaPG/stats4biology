...
One of the first lesson I teach my students is that the experimental results must be (i) replicable and (ii) reproducible and that these two words, in science, assume two completely different meanings. An experiment is replicable whenever it gives the same results when repeated in the very same conditions; in every valid experiment, replicability is ensured by the presence of true-replicates.

On the other hand, reproducibility means something different; it is and it is

that is to say that it gives similar results when it is repeated in different conditions. Of course, failing to reproduce the results of an experiment in different conditions does not necessarily negate the validity of the original results.
