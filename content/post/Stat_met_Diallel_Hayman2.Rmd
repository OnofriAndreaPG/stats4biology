...
4. The $d_i$ and $df_j$ terms relate to the differences between the yield of each selfed parent ($Y_{ij}$, with $i = j$) and the average yield of all selfed parents (**dominance deviation** for the $i^{th}$ parent; DD).
