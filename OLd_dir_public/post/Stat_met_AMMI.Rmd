...
We have seen that AMMI analysis, under the hood, is a sort of PCA. Therefore, it could be performed, in R by using one of the available packages for PCA. For the sake of simplicity, I have coded the simple `AMMI()` function, that is available in the 'statforbiology' package. I have described an earlier version of this function in an 'R news' paper ([Onofri and Ciriciofolo, 2007](https://www.researchgate.net/publication/289419258_Using_R_to_perform_the_AMMI_analysis_on_agriculture_variety_trials)).
...
Thank you for reading, so far, and... happy coding! And ... don't forget to check out my new book!
