...
Now, we can input these elements into the `pairComp()` function in the 'statforbiology' package, considering that we have 63 degrees of freedom in the residuals (see above):
