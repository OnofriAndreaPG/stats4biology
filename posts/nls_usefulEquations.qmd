...
Sigmoidal curves are S-shaped, with two horizontal asymptotes and an inflection point. They are parameterised in countless ways, which may often be confusing, when it comes to selecting the most appropriate function for some specific application. However, for the sake of simplicity, we can consider that there are only three basic equations, that differ for the position of the inflection point. They are:

1. logistic: the ordinate of the inflection point is half-way between lower and upper asymptote, so that the sygmoid is symmetric;
2. Gompertz: the ordinate of the inflection point is closer to the lower asymptote
3. modified Gompertz: the ordinate of the inflection point is closer to the higher asymptote

Furthermore, the shape can also be modified by taking the logarithm of $X$, instead of $X$. This latter modification produces three corresponding Equations, that are

1.
2.
3.

The corresponding shapes can be either increasing or decrising, depending on the selected sign (positive/negative) for one of the parameters. 

basically, sygmoidal curves can be classified according to the direction (i.e.: ascending or descending), the position of the inflection point (i.e., symmetric, early inflection, late inflection), the possible transformation of the predictor (sygmoids based on the untransformed predictor $X$ and sygmoids based on the logarithm of $X$). In practice, we have 12 possible sygmoids to choose from, which, however, arise from slight variations of three basic equations:

1. logistic (symmetric around the inflection point)
2. Gompertz (early inflection)
3. modified Gompertz (late inflection point)

These three forms differ for the position of the inflection point

The position of the inflection point is very relevant to select among the  different functions, as shown . In comparison to a symmetric sygmoid
1. half-way between lower and upper asymptotes, so that the sygmoidal shape is symmetric;
2. closer to the lower asymptote I will show some widespread parameterisations, that are very useful for bioassays or growth studies. All curves can be turned from increasing to decreasing (and vice-versa) by reversing the sign of the $b$ parameter.
